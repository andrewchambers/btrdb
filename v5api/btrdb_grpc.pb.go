...
const (
	BTrDB_RawValues_FullMethodName            = "/v5api.BTrDB/RawValues"
	BTrDB_ArrowRawValues_FullMethodName       = "/v5api.BTrDB/ArrowRawValues"
	BTrDB_MultiRawValues_FullMethodName       = "/v5api.BTrDB/MultiRawValues"
	BTrDB_AlignedWindows_FullMethodName       = "/v5api.BTrDB/AlignedWindows"
	BTrDB_ArrowAlignedWindows_FullMethodName  = "/v5api.BTrDB/ArrowAlignedWindows"
	BTrDB_Windows_FullMethodName              = "/v5api.BTrDB/Windows"
	BTrDB_ArrowWindows_FullMethodName         = "/v5api.BTrDB/ArrowWindows"
	BTrDB_StreamInfo_FullMethodName           = "/v5api.BTrDB/StreamInfo"
	BTrDB_SetStreamAnnotations_FullMethodName = "/v5api.BTrDB/SetStreamAnnotations"
	BTrDB_SetStreamTags_FullMethodName        = "/v5api.BTrDB/SetStreamTags"
	BTrDB_Create_FullMethodName               = "/v5api.BTrDB/Create"
	BTrDB_ListCollections_FullMethodName      = "/v5api.BTrDB/ListCollections"
	BTrDB_LookupStreams_FullMethodName        = "/v5api.BTrDB/LookupStreams"
	BTrDB_Nearest_FullMethodName              = "/v5api.BTrDB/Nearest"
	BTrDB_Changes_FullMethodName              = "/v5api.BTrDB/Changes"
	BTrDB_Insert_FullMethodName               = "/v5api.BTrDB/Insert"
	BTrDB_ArrowInsert_FullMethodName          = "/v5api.BTrDB/ArrowInsert"
	BTrDB_Delete_FullMethodName               = "/v5api.BTrDB/Delete"
	BTrDB_Info_FullMethodName                 = "/v5api.BTrDB/Info"
	BTrDB_FaultInject_FullMethodName          = "/v5api.BTrDB/FaultInject"
	BTrDB_Flush_FullMethodName                = "/v5api.BTrDB/Flush"
	BTrDB_Obliterate_FullMethodName           = "/v5api.BTrDB/Obliterate"
	BTrDB_GetMetadataUsage_FullMethodName     = "/v5api.BTrDB/GetMetadataUsage"
	BTrDB_GenerateCSV_FullMethodName          = "/v5api.BTrDB/GenerateCSV"
	BTrDB_SQLQuery_FullMethodName             = "/v5api.BTrDB/SQLQuery"
	BTrDB_Subscribe_FullMethodName            = "/v5api.BTrDB/Subscribe"
	BTrDB_SetCompactionConfig_FullMethodName  = "/v5api.BTrDB/SetCompactionConfig"
	BTrDB_GetCompactionConfig_FullMethodName  = "/v5api.BTrDB/GetCompactionConfig"
)
...
type BTrDBClient interface {
	...
	ArrowRawValues(ctx context.Context, in *RawValuesParams, opts ...grpc.CallOption) (BTrDB_ArrowRawValuesClient, error)
	...
	ArrowAlignedWindows(ctx context.Context, in *AlignedWindowsParams, opts ...grpc.CallOption) (BTrDB_ArrowAlignedWindowsClient, error)
	Windows(ctx context.Context, in *WindowsParams, opts ...grpc.CallOption) (BTrDB_WindowsClient, error)
	ArrowWindows(ctx context.Context, in *WindowsParams, opts ...grpc.CallOption) (BTrDB_ArrowWindowsClient, error)
	...
	ArrowInsert(ctx context.Context, in *ArrowInsertParams, opts ...grpc.CallOption) (*InsertResponse, error)
...
func (c *bTrDBClient) RawValues(ctx context.Context, in *RawValuesParams, opts ...grpc.CallOption) (BTrDB_RawValuesClient, error) {
	stream, err := c.cc.NewStream(ctx, &BTrDB_ServiceDesc.Streams[0], BTrDB_RawValues_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func (c *bTrDBClient) ArrowRawValues(ctx context.Context, in *RawValuesParams, opts ...grpc.CallOption) (BTrDB_ArrowRawValuesClient, error) {
	stream, err := c.cc.NewStream(ctx, &BTrDB_ServiceDesc.Streams[1], BTrDB_ArrowRawValues_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
	x := &bTrDBArrowRawValuesClient{stream}
	if err := x.ClientStream.SendMsg(in); err != nil {
		return nil, err
	}
	if err := x.ClientStream.CloseSend(); err != nil {
...
type BTrDB_ArrowRawValuesClient interface {
	Recv() (*ArrowRawValuesResponse, error)
	grpc.ClientStream
}

type bTrDBArrowRawValuesClient struct {
	grpc.ClientStream
}

func (x *bTrDBArrowRawValuesClient) Recv() (*ArrowRawValuesResponse, error) {
	m := new(ArrowRawValuesResponse)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
	return m, nil
...
func (c *bTrDBClient) MultiRawValues(ctx context.Context, in *MultiRawValuesParams, opts ...grpc.CallOption) (BTrDB_MultiRawValuesClient, error) {
	stream, err := c.cc.NewStream(ctx, &BTrDB_ServiceDesc.Streams[2], BTrDB_MultiRawValues_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func (c *bTrDBClient) AlignedWindows(ctx context.Context, in *AlignedWindowsParams, opts ...grpc.CallOption) (BTrDB_AlignedWindowsClient, error) {
	stream, err := c.cc.NewStream(ctx, &BTrDB_ServiceDesc.Streams[3], BTrDB_AlignedWindows_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func (c *bTrDBClient) ArrowAlignedWindows(ctx context.Context, in *AlignedWindowsParams, opts ...grpc.CallOption) (BTrDB_ArrowAlignedWindowsClient, error) {
	stream, err := c.cc.NewStream(ctx, &BTrDB_ServiceDesc.Streams[4], BTrDB_ArrowAlignedWindows_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
	x := &bTrDBArrowAlignedWindowsClient{stream}
	if err := x.ClientStream.SendMsg(in); err != nil {
		return nil, err
	}
	if err := x.ClientStream.CloseSend(); err != nil {
...
type BTrDB_ArrowAlignedWindowsClient interface {
	Recv() (*ArrowAlignedWindowsResponse, error)
	grpc.ClientStream
}

type bTrDBArrowAlignedWindowsClient struct {
	grpc.ClientStream
}

func (x *bTrDBArrowAlignedWindowsClient) Recv() (*ArrowAlignedWindowsResponse, error) {
	m := new(ArrowAlignedWindowsResponse)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
	return m, nil
...
func (c *bTrDBClient) Windows(ctx context.Context, in *WindowsParams, opts ...grpc.CallOption) (BTrDB_WindowsClient, error) {
	stream, err := c.cc.NewStream(ctx, &BTrDB_ServiceDesc.Streams[5], BTrDB_Windows_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func (c *bTrDBClient) ArrowWindows(ctx context.Context, in *WindowsParams, opts ...grpc.CallOption) (BTrDB_ArrowWindowsClient, error) {
	stream, err := c.cc.NewStream(ctx, &BTrDB_ServiceDesc.Streams[6], BTrDB_ArrowWindows_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
	x := &bTrDBArrowWindowsClient{stream}
	if err := x.ClientStream.SendMsg(in); err != nil {
		return nil, err
	}
	if err := x.ClientStream.CloseSend(); err != nil {
...
type BTrDB_ArrowWindowsClient interface {
	Recv() (*ArrowWindowsResponse, error)
	grpc.ClientStream
}

type bTrDBArrowWindowsClient struct {
	grpc.ClientStream
}

func (x *bTrDBArrowWindowsClient) Recv() (*ArrowWindowsResponse, error) {
	m := new(ArrowWindowsResponse)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
	return m, nil
...
func (c *bTrDBClient) StreamInfo(ctx context.Context, in *StreamInfoParams, opts ...grpc.CallOption) (*StreamInfoResponse, error) {
	...
	err := c.cc.Invoke(ctx, BTrDB_StreamInfo_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *bTrDBClient) SetStreamAnnotations(ctx context.Context, in *SetStreamAnnotationsParams, opts ...grpc.CallOption) (*SetStreamAnnotationsResponse, error) {
	...
	err := c.cc.Invoke(ctx, BTrDB_SetStreamAnnotations_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *bTrDBClient) SetStreamTags(ctx context.Context, in *SetStreamTagsParams, opts ...grpc.CallOption) (*SetStreamTagsResponse, error) {
	...
	err := c.cc.Invoke(ctx, BTrDB_SetStreamTags_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *bTrDBClient) Create(ctx context.Context, in *CreateParams, opts ...grpc.CallOption) (*CreateResponse, error) {
	...
	err := c.cc.Invoke(ctx, BTrDB_Create_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *bTrDBClient) ListCollections(ctx context.Context, in *ListCollectionsParams, opts ...grpc.CallOption) (BTrDB_ListCollectionsClient, error) {
	stream, err := c.cc.NewStream(ctx, &BTrDB_ServiceDesc.Streams[7], BTrDB_ListCollections_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func (c *bTrDBClient) LookupStreams(ctx context.Context, in *LookupStreamsParams, opts ...grpc.CallOption) (BTrDB_LookupStreamsClient, error) {
	stream, err := c.cc.NewStream(ctx, &BTrDB_ServiceDesc.Streams[8], BTrDB_LookupStreams_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func (c *bTrDBClient) Nearest(ctx context.Context, in *NearestParams, opts ...grpc.CallOption) (*NearestResponse, error) {
	...
	err := c.cc.Invoke(ctx, BTrDB_Nearest_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *bTrDBClient) Changes(ctx context.Context, in *ChangesParams, opts ...grpc.CallOption) (BTrDB_ChangesClient, error) {
	stream, err := c.cc.NewStream(ctx, &BTrDB_ServiceDesc.Streams[9], BTrDB_Changes_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func (c *bTrDBClient) Insert(ctx context.Context, in *InsertParams, opts ...grpc.CallOption) (*InsertResponse, error) {
	...
	err := c.cc.Invoke(ctx, BTrDB_Insert_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *bTrDBClient) ArrowInsert(ctx context.Context, in *ArrowInsertParams, opts ...grpc.CallOption) (*InsertResponse, error) {
	out := new(InsertResponse)
	err := c.cc.Invoke(ctx, BTrDB_ArrowInsert_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *bTrDBClient) Delete(ctx context.Context, in *DeleteParams, opts ...grpc.CallOption) (*DeleteResponse, error) {
	...
	err := c.cc.Invoke(ctx, BTrDB_Delete_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *bTrDBClient) Info(ctx context.Context, in *InfoParams, opts ...grpc.CallOption) (*InfoResponse, error) {
	...
	err := c.cc.Invoke(ctx, BTrDB_Info_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *bTrDBClient) FaultInject(ctx context.Context, in *FaultInjectParams, opts ...grpc.CallOption) (*FaultInjectResponse, error) {
	...
	err := c.cc.Invoke(ctx, BTrDB_FaultInject_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *bTrDBClient) Flush(ctx context.Context, in *FlushParams, opts ...grpc.CallOption) (*FlushResponse, error) {
	...
	err := c.cc.Invoke(ctx, BTrDB_Flush_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *bTrDBClient) Obliterate(ctx context.Context, in *ObliterateParams, opts ...grpc.CallOption) (*ObliterateResponse, error) {
	...
	err := c.cc.Invoke(ctx, BTrDB_Obliterate_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *bTrDBClient) GetMetadataUsage(ctx context.Context, in *MetadataUsageParams, opts ...grpc.CallOption) (*MetadataUsageResponse, error) {
	...
	err := c.cc.Invoke(ctx, BTrDB_GetMetadataUsage_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *bTrDBClient) GenerateCSV(ctx context.Context, in *GenerateCSVParams, opts ...grpc.CallOption) (BTrDB_GenerateCSVClient, error) {
	stream, err := c.cc.NewStream(ctx, &BTrDB_ServiceDesc.Streams[10], BTrDB_GenerateCSV_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func (c *bTrDBClient) SQLQuery(ctx context.Context, in *SQLQueryParams, opts ...grpc.CallOption) (BTrDB_SQLQueryClient, error) {
	stream, err := c.cc.NewStream(ctx, &BTrDB_ServiceDesc.Streams[11], BTrDB_SQLQuery_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func (c *bTrDBClient) Subscribe(ctx context.Context, in *SubscriptionParams, opts ...grpc.CallOption) (BTrDB_SubscribeClient, error) {
	stream, err := c.cc.NewStream(ctx, &BTrDB_ServiceDesc.Streams[12], BTrDB_Subscribe_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func (c *bTrDBClient) SetCompactionConfig(ctx context.Context, in *SetCompactionConfigParams, opts ...grpc.CallOption) (*SetCompactionConfigResponse, error) {
	...
	err := c.cc.Invoke(ctx, BTrDB_SetCompactionConfig_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *bTrDBClient) GetCompactionConfig(ctx context.Context, in *GetCompactionConfigParams, opts ...grpc.CallOption) (*GetCompactionConfigResponse, error) {
	...
	err := c.cc.Invoke(ctx, BTrDB_GetCompactionConfig_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type BTrDBServer interface {
	...
	ArrowRawValues(*RawValuesParams, BTrDB_ArrowRawValuesServer) error
	...
	ArrowAlignedWindows(*AlignedWindowsParams, BTrDB_ArrowAlignedWindowsServer) error
	Windows(*WindowsParams, BTrDB_WindowsServer) error
	ArrowWindows(*WindowsParams, BTrDB_ArrowWindowsServer) error
	...
	ArrowInsert(context.Context, *ArrowInsertParams) (*InsertResponse, error)
...
func (UnimplementedBTrDBServer) ArrowRawValues(*RawValuesParams, BTrDB_ArrowRawValuesServer) error {
	return status.Errorf(codes.Unimplemented, "method ArrowRawValues not implemented")
}
...
func (UnimplementedBTrDBServer) ArrowAlignedWindows(*AlignedWindowsParams, BTrDB_ArrowAlignedWindowsServer) error {
	return status.Errorf(codes.Unimplemented, "method ArrowAlignedWindows not implemented")
}
...
func (UnimplementedBTrDBServer) ArrowWindows(*WindowsParams, BTrDB_ArrowWindowsServer) error {
	return status.Errorf(codes.Unimplemented, "method ArrowWindows not implemented")
}
...
func (UnimplementedBTrDBServer) ArrowInsert(context.Context, *ArrowInsertParams) (*InsertResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ArrowInsert not implemented")
}
...
func _BTrDB_ArrowRawValues_Handler(srv interface{}, stream grpc.ServerStream) error {
	m := new(RawValuesParams)
	if err := stream.RecvMsg(m); err != nil {
		return err
	}
	return srv.(BTrDBServer).ArrowRawValues(m, &bTrDBArrowRawValuesServer{stream})
}

type BTrDB_ArrowRawValuesServer interface {
	Send(*ArrowRawValuesResponse) error
	grpc.ServerStream
}

type bTrDBArrowRawValuesServer struct {
	grpc.ServerStream
}

func (x *bTrDBArrowRawValuesServer) Send(m *ArrowRawValuesResponse) error {
	return x.ServerStream.SendMsg(m)
}
...
func _BTrDB_ArrowAlignedWindows_Handler(srv interface{}, stream grpc.ServerStream) error {
	m := new(AlignedWindowsParams)
	if err := stream.RecvMsg(m); err != nil {
		return err
	}
	return srv.(BTrDBServer).ArrowAlignedWindows(m, &bTrDBArrowAlignedWindowsServer{stream})
}

type BTrDB_ArrowAlignedWindowsServer interface {
	Send(*ArrowAlignedWindowsResponse) error
	grpc.ServerStream
}

type bTrDBArrowAlignedWindowsServer struct {
	grpc.ServerStream
}

func (x *bTrDBArrowAlignedWindowsServer) Send(m *ArrowAlignedWindowsResponse) error {
	return x.ServerStream.SendMsg(m)
}
...
func _BTrDB_ArrowWindows_Handler(srv interface{}, stream grpc.ServerStream) error {
	m := new(WindowsParams)
	if err := stream.RecvMsg(m); err != nil {
		return err
	}
	return srv.(BTrDBServer).ArrowWindows(m, &bTrDBArrowWindowsServer{stream})
}

type BTrDB_ArrowWindowsServer interface {
	Send(*ArrowWindowsResponse) error
	grpc.ServerStream
}

type bTrDBArrowWindowsServer struct {
	grpc.ServerStream
}

func (x *bTrDBArrowWindowsServer) Send(m *ArrowWindowsResponse) error {
	return x.ServerStream.SendMsg(m)
}
...
func _BTrDB_StreamInfo_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: BTrDB_StreamInfo_FullMethodName,
	}
...
func _BTrDB_SetStreamAnnotations_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: BTrDB_SetStreamAnnotations_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _BTrDB_SetStreamTags_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: BTrDB_SetStreamTags_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _BTrDB_Create_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: BTrDB_Create_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _BTrDB_Nearest_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: BTrDB_Nearest_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _BTrDB_Insert_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: BTrDB_Insert_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _BTrDB_ArrowInsert_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ArrowInsertParams)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(BTrDBServer).ArrowInsert(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: BTrDB_ArrowInsert_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(BTrDBServer).ArrowInsert(ctx, req.(*ArrowInsertParams))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _BTrDB_Delete_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: BTrDB_Delete_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _BTrDB_Info_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: BTrDB_Info_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _BTrDB_FaultInject_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: BTrDB_FaultInject_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _BTrDB_Flush_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: BTrDB_Flush_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _BTrDB_Obliterate_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: BTrDB_Obliterate_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _BTrDB_GetMetadataUsage_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: BTrDB_GetMetadataUsage_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _BTrDB_SetCompactionConfig_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: BTrDB_SetCompactionConfig_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _BTrDB_GetCompactionConfig_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: BTrDB_GetCompactionConfig_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var BTrDB_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "ArrowInsert",
			Handler:    _BTrDB_ArrowInsert_Handler,
		},
		{
			MethodName: "Delete",
	...
	Streams: []grpc.StreamDesc{
		...
		{
			StreamName:    "ArrowRawValues",
			Handler:       _BTrDB_ArrowRawValues_Handler,
			ServerStreams: true,
		},
		{
		...
		{
			StreamName:    "ArrowAlignedWindows",
			Handler:       _BTrDB_ArrowAlignedWindows_Handler,
			ServerStreams: true,
		},
		{
			StreamName:    "Windows",
		...
		{
			StreamName:    "ArrowWindows",
			Handler:       _BTrDB_ArrowWindows_Handler,
			ServerStreams: true,
		},
		{
